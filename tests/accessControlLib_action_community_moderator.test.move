#[test_only]
module peeranha::accessControlLib_action_community_moderator_test
{
    ...
    fun test_community_moderator_create_bot_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test, expected_failure(abort_code = accessControlLib::E_NOT_ALLOWED_NOT_BOT_ROLE)]
    fun test_community_moderator_create_bot_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_moderator_edit_own_official_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_moderator_edit_not_own_official_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
