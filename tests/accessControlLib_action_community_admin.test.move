#[test_only]
module peeranha::accessControlLib_action_community_admin_test
{
    ...
    #[test]
    fun test_community_admin_update_profile() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
            time = init_accessControlLib_community_admin_for_user2(scenario);
        };
    ...
    #[test]
    fun test_community_admin_create_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_create_bot_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_edit_own_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_edit_not_own_post_meta_data() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_delete_own_post_meta_data() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_delete_not_own_post_meta_data() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_create_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test, expected_failure(abort_code = accessControlLib::E_NOT_ALLOWED_NOT_BOT_ROLE)]
    fun test_community_admin_create_bot_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_create_official_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_edit_own_official_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_edit_not_own_official_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_edit_own_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_edit_not_exist_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_edit_deleted_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_edit_not_own_reply_meta_data() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_set_not_own_best_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test, expected_failure(abort_code = userLib::E_NOT_ALLOWED_DELETE)]
    fun test_community_admin_deleted_not_own_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_create_comment_to_not_own_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test, expected_failure(abort_code = userLib::E_LOW_RATING_CREATE_COMMENT)]
    fun test_community_admin_create_comment_to_not_own_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_create_comment_to_own_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_create_comment_to_own_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test, expected_failure(abort_code = userLib::E_NOT_ALLOWED_DELETE)]
    fun test_community_admin_delete_not_own_comment_to_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test, expected_failure(abort_code = userLib::E_NOT_ALLOWED_DELETE)]
    fun test_community_admin_delete_not_own_comment_to_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_upvote_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_cancel_vote_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_downvote_post() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_upvote_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_cancel_vote_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_downvote_reply() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_upvote_comment() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_cancel_vote_comment() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_downvote_comment() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    fun test_community_admin_create_community() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_update_community() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_update_documentation() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_create_tag() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_update_tag() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_freeze_community() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    #[test]
    fun test_community_admin_unfreeze_community() {
        let scenario_val = test_scenario::begin(USER1);
        let scenario = &mut scenario_val;
        let time;
        {
    ...
    public fun init_accessControlLib_community_admin_for_user2(scenario: &mut Scenario) : clock::Clock {
        ...
        test_scenario::next_tx(scenario, USER1);
        {
            ...
            let community = &mut community_val;
            accessControlLib_common_role_test::grant_community_admin_role(object::id(&mut user2_val), community, scenario);
